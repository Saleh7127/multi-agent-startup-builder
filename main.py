...
Uses the Brain Agent to orchestrate all agents sequentially.
"""
...
async def main():
    """Run the brain agent with a startup idea."""
    if len(sys.argv) < 2:
    ...
    runner = InMemoryRunner(agent=brain_agent)
    
    print("🧠 Brain Agent orchestrating all agents sequentially...\n")
    try:
